    ...
    <div>
      <div className="flex items-end justify-between mb-4 gap-4 flex-wrap">
        <div className="flex items-center gap-3 min-w-0">
          <div className="w-1 h-9 rounded-full bg-gradient-to-b from-accent to-primary shrink-0" />
          <h2
      ...
      {loading ? (
        ...
        <HCarousel ariaLabel="Artistes en hausse">
          {rows.map((a, i) => (
            ...
            >
              <Link
                to={a.kind === "remixer" ? `/remixers/${a.slug}` : `/artists/${encodeURIComponent(a.name)}`}
